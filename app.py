...
def download_file(filename):
    ...
    if not os.path.exists(filepath):
        return "<h1>Errore: File non trovato.</h1><p>Il link per il download potrebbe essere scaduto o il server potrebbe essere stato riavviato. Per favore, prova a riconvertire il video.</p>", 404
